...
from config import (
    WAIT_PHOTO, CONFIRMATION, EDIT_ITEM, FINAL_CONFIRMATION, SELECT_EDIT_ITEM, 
    user_data
)
from utils.error_handling import log_error
from utils.invoice_processing import format_invoice_data, format_final_invoice, prepare_invoice_data_for_syrve, save_invoice_data
from services.syrve_service import authenticate, send_invoice_to_syrve, commit_document
    ...
    try:
        ...
        if user_id not in user_data:
            await query.edit_message_text(
                text="❌ Error: Invoice data not found."
            )
            return WAIT_PHOTO
