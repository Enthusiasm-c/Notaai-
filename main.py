...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[logging.FileHandler("logs/nota_bot.log"), logging.StreamHandler()],
    )
...
def import_modules():
    ...
    try:
        ...
        try:
            command_handlers = load_module(
                "command_handlers",
                os.path.join(current_dir, "handlers/command_handlers.py"),
            )
            invoice_handlers = load_module(
                "invoice_handlers",
                os.path.join(current_dir, "handlers/invoice_handlers.py"),
            )
            confirmation_handlers = load_module(
                "confirmation_handlers",
                os.path.join(current_dir, "handlers/confirmation_handlers.py"),
            )
    ...
    try:
        ...
        conv_handler = ConversationHandler(
            ...
            states={
                ...
                SELECT_EDIT_ITEM: [CallbackQueryHandler(handle_item_selection)],
